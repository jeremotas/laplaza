...
var aStarters = [	
	{
		...
		"add_descanso": false,
		"arriba_izquierda": {"unit_type": "english_cavalry", "seconds": 1, "probability": 0},
		"arriba_centro": {"unit_type": "english_cavalry", "seconds": 1, "probability":100},
		"arriba_derecha": {"unit_type": "english_cavalry", "seconds": 1, "probability": 0},
		"izquierda_superior": {"unit_type": "english_cavalry", "seconds": 2, "probability": 80},
		"izquierda_inferior": {"unit_type": "english_cavalry", "seconds": 1, "probability": 0},
		"derecha_superior": {"unit_type": "english_cavalry", "seconds": 2, "probability": 80},
		"derecha_inferior": {"unit_type": "english_cavalry", "seconds": 1, "probability": 0},
	}
]
var aFirstWaves = [
	{
